...
/* Definitions for mainTaskTimer */
osTimerId_t mainTaskTimerHandle;
osStaticTimerDef_t mainTaskTimerControlBlock;
const osTimerAttr_t mainTaskTimer_attributes = {
  .name = "mainTaskTimer",
  .cb_mem = &mainTaskTimerControlBlock,
  .cb_size = sizeof(mainTaskTimerControlBlock),
};
...
extern void mainTaskTimerCallback(void *argument);
...
int main(void)
{
  ...
  /* Create the timer(s) */
  /* creation of mainTaskTimer */
  mainTaskTimerHandle = osTimerNew(mainTaskTimerCallback, osTimerOnce, NULL, &mainTaskTimer_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_CLK_Pin|LCD_DIO_Pin, GPIO_PIN_RESET);
...
/* USER CODE BEGIN Header_MainTaskCode */
/**
* @brief Function implementing the MainTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_MainTaskCode */
__weak void MainTaskCode(void *argument)
{
  /* USER CODE BEGIN MainTaskCode */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END MainTaskCode */
}
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  if (htim==&htim3) 
  {
    //todo: countdown ended without winners
  }
